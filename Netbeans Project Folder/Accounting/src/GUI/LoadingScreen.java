...
public class LoadingScreen extends javax.swing.JFrame {
    ...
    public LoadingScreen() {
        ...
        this.setTitle("Accounting Management");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Accounting Management");

        jLabel7.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 0, 0));
        jLabel7.setText("<<Simple accounting software for all>>");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/appsmall.png"))); // NOI18N
        jLabel2.setText("jLabel2");

        progressBar.setForeground(new java.awt.Color(255, 153, 51));

        loadingLabel.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
